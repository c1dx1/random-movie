...
func movieHandler(w http.ResponseWriter, r *http.Request) {
	...
	movieData.IsLogged = ok && username != ""
...
func main() {
	...
	r.HandleFunc("/postform", movieHandler).Methods("POST")
	r.HandleFunc("/favorites", favoriteHandler).Methods("GET")
	r.HandleFunc("/register", registerHandler).Methods("GET", "POST")
	r.HandleFunc("/login", loginHandler).Methods("GET", "POST")
	r.HandleFunc("/logout", logoutHandler).Methods("GET")
	r.HandleFunc("/add_favorite", addFavoriteHandler).Methods("POST")
	r.HandleFunc("/remove_favorite", removeFavoriteHandler).Methods("POST")
